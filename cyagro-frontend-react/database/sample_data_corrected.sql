...
-- Συμβατό με το νέο schema και FastAPI models
-- ===================================================================
...
-- Sample users με hashed passwords (password: "secret" για όλους)
...
-- Sample agricultural plots (χρειάζονται cultivation_id από την υπάρχουσα βάση)
-- Assuming cultivations exist with IDs 1, 2, 3, 4
...
(2, 1, 2, 175000, '2024-03-01', '2024-08-15', 'Καταιονισμός', 'Βιολογική καλλιέργεια', 'planted'),
(3, 2, 3, 300000, '2023-11-20', '2024-10-30', 'Πλημμυριστική', 'Παραδοσιακή καλλιέργεια', 'growing'),
(5, 2, 4, 350000, '2024-02-10', '2024-07-20', 'Σταγόνα', 'Νέα φυτεία', 'planted');

-- ================= CULTIVATION DECLARATIONS =================

-- Sample cultivation declarations
...
-- Sample damage declarations (χρειάζονται harmful_cause_id από την υπάρχουσα βάση)
-- Assuming harmful causes exist with IDs 1, 2, 3
...
(2, 3, 3, '2024-06-20', 68250, 22.75, 1800.00, 'Ζημιές από ξηρασία στην ελιά. Επηρεάστηκαν οι ανθοφορίες.', 'approved');
...
(NULL, 2, 'drought_damage_report.pdf', 'Αναφορά_Ξηρασίας.pdf', '/uploads/damage/drought_damage_report.pdf', 345621, 'application/pdf', 'other');
...
-- Test user passwords: all users have password "secret"