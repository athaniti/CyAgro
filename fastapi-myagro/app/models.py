...
class User(Base):
    ...
    damage_declarations = relationship("DamageDeclaration", back_populates="user", foreign_keys="[DamageDeclaration.user_id]")
...
class DamageDeclaration(Base):
    ...
    # Relationships
    user = relationship("User", back_populates="damage_declarations",foreign_keys="[DamageDeclaration.user_id]")
